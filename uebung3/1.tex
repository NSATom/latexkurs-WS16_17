...
% forcibly put on top to fit the other on bottom
% this table is technically easier than the other one, we think its also the
% better looking one, but yeah, to toy around with multicolumn theres the 2nd
% table tab:andersvielsagend
\begin{table}[h]
